        ...
        <div className="rounded-xl border border-line bg-bg-surface p-6 sm:p-8 shadow-card">
          ...
          <form onSubmit={handleEmailSubmit} className="space-y-3.5">
            ...
            <div className="flex justify-end -mt-1.5">
              <Link
                to="/forgot-password"
                className="text-[11px] text-ink-muted hover:text-brand-cyan transition-colors font-mono"
              >
                Forgot password?
              </Link>
            </div>
          ...
          <p className="mt-5 text-center text-[12px] text-ink-muted">
            No account yet?{' '}
            <Link to="/signup" className="text-brand-cyan hover:text-brand-blue transition-colors font-medium">
              Create one
            </Link>
          </p>
        </div>
